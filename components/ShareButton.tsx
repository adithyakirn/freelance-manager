            ...
            {typeof document !== "undefined" &&
              createPortal(
                <motion.div
                  ...
                  className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-md z-[100]"
                >
                  <div className="glass-card p-6 border border-white/10 shadow-2xl bg-[#0a0a0a]/90 backdrop-blur-xl">
                    {/* Header */}
                    ...
                    <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 mb-4 border border-white/5 hover:border-white/10 transition-colors">
                      <div>
                    ...
                    {shareEnabled && shareToken && (
                      <div className="mb-4">
                        ...
                        <div className="flex gap-2">
                          <div className="flex-1 flex items-center gap-2 px-4 py-3 bg-[#1A1A1A] border border-white/10 rounded-xl overflow-hidden">
                          ...
                          <button
                            ...
                            className={`px-4 py-3 rounded-xl transition-colors shrink-0 ${
                              copied
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-[#1A1A1A] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:border-blue-500/50 focus:outline-none transition-colors"
                        />
                        <button
                          onClick={handleSaveProgress}
                          disabled={savingStatus}
                          className="px-4 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white transition-colors disabled:opacity-50 shrink-0"
                        >
                          {savingStatus ? (
